	...
	try {
		switch (action) {
			case 'share':
				...
				break;
			case 'voice-call':
				if (window.startCall && roomsData[activeRoomIndex].privateChatTargetId) {
					window.startCall(roomsData[activeRoomIndex].privateChatTargetId, false);
				}
				break;
			case 'video-call':
				if (window.startCall && roomsData[activeRoomIndex].privateChatTargetId) {
					window.startCall(roomsData[activeRoomIndex].privateChatTargetId, true);
				}
				break;
			case 'exit':
				handleExitAction();
